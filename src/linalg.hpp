#ifndef __FILE_V2S_LINALG_HPP
#define __FILE_V2S_LINALG_HPP

#include <bla.hpp>
#include <math.h>

namespace voxel2stl::linalg
{

  // from https://www.mpi-hd.mpg.de/personalhomes/globes/3x3/ - slightly modified
